...
import org.apache.beam.repackaged.core.org.apache.commons.lang3.reflect.Typed;
...
public class Task {
  ...
  public static void main(String[] args) {
    ...
    PCollection<String> countries =
        pipeline.apply("Read Countries", TextIO.read().from("countries.txt"));
  ...
  static PCollection<String> applyTransform(PCollection<String> input) {
    return
            input.apply(MapElements.into(TypeDescriptors.strings())
                    .via( word -> word.toUpperCase(Locale.ROOT)));
  }
